(() => {
  ...
  class MiniQPet {
    ...
    build() {
      ...
      this.frames = { idle: `${this.basePath}/mini-q-pet/huaxiang-q-main.png`, left: `${this.basePath}/mini-q-pet/walk-left-v2.png`, right: `${this.basePath}/mini-q-pet/walk-right-v2.png` };
      this.image.src = this.frames.idle;
    }

    bind() {
      this.listen(this.toggle, "click", () => this.settings.enabled ? this.closeMode(true) : this.openMode());
      this.listen(this.root.querySelector(".qp-disable"), "click", () => this.closeMode(true));
